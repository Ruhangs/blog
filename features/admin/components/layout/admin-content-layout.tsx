...
export const AdminContentLayout = ({
  ...
  return (
    <div className="w-full flex flex-col space-y-4 relative">
      <div
        className={cn(
          'sticky top-0 bg-background p-6 lg:px-12 pb-2 backdrop-blur-lg transition-[background-color,border-width]',
          (scroll?.top ?? 0) > 60 &&
      ...
      {/* <ScrollArea
        className="px-6 lg:px-12 animate-fade h-[calc(100vh-174px)]"
        scrollAreaRef={scrollRef}
      > */}
      <div className="px-6 lg:px-12 animate-fade h-[calc(100vh-174px)]">
        {children}
      </div>
      {/* </ScrollArea> */}
