...
export const PATHS_MAP: Record<string, string> = {
  ...
  [PATHS.ADMIN_SNIPPET]: '项目文档',
  [PATHS.ADMIN_SNIPPET_CREATE]: '创建项目文档',
  [PATHS.ADMIN_SNIPPET_EDIT]: '编辑项目文档',
  [PATHS.ADMIN_TAG]: '标签',
  [PATHS.ADMIN_NOTE]: '笔记',
...
export const PATH_DESCRIPTION_MAP: Record<string, string> = {
  ...
  [PATHS.SITE_SNIPPET]: '多是一些零零碎碎的项目文档，通常是代码项目文档',
  [PATHS.SITE_ABOUT]: `叮～ 你有一份关于${NAME}的简介，请查收～`,
  ...
  [PATHS.ADMIN_SNIPPET]: `项目文档管理，在这里对项目文档进行 增、删、改、查操作`,
...
export const NOADMIN_PATH_DESCRIPTION_MAP: Record<string, string> = {
  /** ************* SITE ****************** */
  [PATHS.SITE_HOME]: '首页',
  [PATHS.SITE_BLOG]: '这里记录了我的想法、文章，希望和大家一起交流～',
  [PATHS.SITE_SNIPPET]: '多是一些零零碎碎的项目文档，通常是代码项目文档',
  ...
  /** ************* ADMIN ****************** */
  [PATHS.ADMIN_HOME]: '欢迎您，有问题可提issue～',
  [PATHS.ADMIN_STATISTIC]: '聚合本站的所有统计数据',
  [PATHS.ADMIN_BLOG]: `博客管理，游客仅可查看`,
  [PATHS.ADMIN_BLOG_CREATE]: '在这里尽情地创作吧！',
  [PATHS.ADMIN_BLOG_EDIT]:
    '世界破破烂烂，博客修修补补，好的文章总是需要反复打磨的',
  [PATHS.ADMIN_SNIPPET]: `项目文档管理，游客仅可查看`,
  [PATHS.ADMIN_SNIPPET_CREATE]:
    'Talk is cheap. Show me the code. From Linus Torvalds',
  [PATHS.ADMIN_SNIPPET_EDIT]: '修修补补，总比没有好',
  [PATHS.ADMIN_TAG]: `标签管理，游客仅可查看`,
  [PATHS.ADMIN_NOTE]: '好记性不如烂笔头，灵感一闪',
